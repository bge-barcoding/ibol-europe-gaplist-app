...
python src/arise/barcode/metadata/util/arise_load_Jorinde_excel.py -db data/sqlite/arise-barcode-metadata.db -marker ITS -excel data/input_files/Fungi\ barcodes\ Jorinde.xlsx -kingdom fungi
# WI
python src/arise/barcode/metadata/util/arise_load_WI_excel.py -db data/sqlite/ignored/arise-barcode-metadata.db -excel data/input_files/WI_DutchStrainsWithPublicBarcodes.xlsx
# build DB tree
