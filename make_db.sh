...
# BOLD GLOBAL DATA
python src/arise/barcode/metadata/util/arise_load_bold.py -db data/sqlite/ignored/arise-barcode-metadata.db -tsv data/input_files/BOLD/BOLD_20230203_Animalia.tsv.gz -kingdom animalia &&
python src/arise/barcode/metadata/util/arise_load_bold.py -db data/sqlite/ignored/arise-barcode-metadata.db -tsv data/input_files/BOLD/BOLD_20230203_Plantae.tsv.gz -kingdom plantae &&
python src/arise/barcode/metadata/util/arise_load_bold.py -db data/sqlite/ignored/arise-barcode-metadata.db -tsv data/input_files/BOLD/BOLD_20230203_Fungi.tsv.gz -kingdom fungi &&
